...
open class BaseShiurimPageActivity : AppCompatActivity(), TorahFilterable, HoldsShiurCard {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listOfShiurim =
            (intent.getParcelableArrayExtra(CONSTANTS.INTENT_EXTRA_SPEAKER_CHILD_SHIURIM) as ArrayList<Shiur>?)?.toMutableList()
                ?: mutableListOf(
                    ShiurFullPage(
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        FunctionLibrary.setupFilterAndSearch(
            ...
            TAG,
            mapOf(
                /*getTabTypeString(*/ShiurFilterOption.SPEAKER/*)*/ to listOfSpeakerNames,
                /*getTabTypeString(*/ShiurFilterOption.CATEGORY/*)*/ to listOfCategoryNames,
                /*getTabTypeString(*/ShiurFilterOption.SERIES/*)*/  to listOfSeriesNames,
                                     ShiurFilterOption.LENGTH       to listOf("1","5","17","22","19","81","155","187","300","500","1000","2000","3000","4000","5000","32400"),
